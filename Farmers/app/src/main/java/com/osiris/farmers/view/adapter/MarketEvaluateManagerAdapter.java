...
public class MarketEvaluateManagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MarketEvaluateManagerAdapter(List<MarketManagerEvaluate> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<MarketManagerEvaluate> dataList) {
        this.dataList = dataList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_evaulate_shichangl, parent, false);//解决宽度不能铺满
    ...
    class MarketEvaluateHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindData(MarketManagerEvaluate data) {
