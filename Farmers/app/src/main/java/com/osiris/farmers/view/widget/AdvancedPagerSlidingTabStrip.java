package com.osiris.farmers.view.widget;
...
//        txtParams.addRule(RelativeLayout.CENTER_IN_PARENT);
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.dp10), getResources().getDimensionPixelSize(R.dimen.dp10));
        TextView dot = new TextView(getContext());
        dot.setTextColor(Color.WHITE);
        dot.setBackgroundColor(Color.BLUE);
        dot.setGravity(Gravity.CENTER);
        dot.setSingleLine();
        dot.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimensionPixelSize(R.dimen.sp10));
        //16 new
        Drawable dot_drawable = ResourcesCompat.getDrawable(getResources(), R.drawable.apsts_tips, null);


        boolean hasRule = false;
        layoutParams.setMargins(0, 0, getResources().getDimensionPixelSize(R.dimen.dp9), 0);
...
//            layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            layoutParams.addRule(RelativeLayout.ALIGN_RIGHT, R.id.id_tab_tv);
            layoutParams.addRule(RelativeLayout.ALIGN_TOP, R.id.id_tab_tv);
            int halfSize = getResources().getDimensionPixelSize(R.dimen.dp8);
    ...
    private void addViewTab(final int position, ViewTabProvider provider, String title) {
        ...
        viewLayoutParams.addRule(RelativeLayout.ABOVE, R.id.id_tab_tv);
