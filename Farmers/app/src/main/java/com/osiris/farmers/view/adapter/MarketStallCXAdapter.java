...
public class MarketStallCXAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MarketStallCXAdapter(List<StallCX.DataBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<StallCX.DataBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class DateHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(StallCX.DataBean data){
