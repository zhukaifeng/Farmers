...
public class ChargeTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ChargeTypeAdapter(List<DateModel> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_selec_charget_button, parent,false);//解决宽度不能铺满
