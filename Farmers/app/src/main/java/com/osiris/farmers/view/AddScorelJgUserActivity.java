...
public class AddScorelJgUserActivity extends BaseActivity {
    ...
    private List<AddScore.ZhanghglsBean> dataList = new ArrayList<>();
        ...
        NetRequest.request(url, ApiRequestTag.DATA, paramMap, new NetRequestResultListener() {
            ...
            public void requestSuccess(int tag, String successResult) {
                ...
                new Handler().post(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AddScorelJgUserActivity.this, "全部提交成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
        ...
        NetRequest.request(url, ApiRequestTag.DATA, paramMap, new NetRequestResultListener() {
            ...
            public void requestSuccess(int tag, String successResult) {
                ...
                if (json.has("zhanghgls")){
                    ...
                    if (dataList.size()>0){
                        for (AddScore.ZhanghglsBean marketsBean:dataList){
                            selectName.add("               " + marketsBean.getJcyname() + "               ");
