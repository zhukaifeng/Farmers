...
public class AddScoreJgMraketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


	private MyItemClickListener myItemClickListener;

	private List<AddScore.PingjiaxxsBean>  dataList = new ArrayList<>();
	...
	public AddScoreJgMraketAdapter(List<AddScore.PingjiaxxsBean> dataList) {
		this.dataList = dataList;
	}

	public void setDataList(List<AddScore.PingjiaxxsBean> dataList) {
		this.dataList = dataList;
	}
	...
	class BillOflandSelectHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
		...
		public void bindData(AddScore.PingjiaxxsBean data){
