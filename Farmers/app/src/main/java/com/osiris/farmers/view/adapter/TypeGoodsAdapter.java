...
public class TypeGoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


    private MyItemClickListener myItemClickListener;

    private List<GoodsType.DescriptionBean> dataList = new ArrayList<>();


    public TypeGoodsAdapter(List<GoodsType.DescriptionBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<GoodsType.DescriptionBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class DateHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(GoodsType.DescriptionBean data){
            tv_date.setText(data.getDescriptionnm());
            if (data.isClicked()){
