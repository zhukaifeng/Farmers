...
public class MarketScoreDetaiShichangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
	...
	public MarketScoreDetaiShichangAdapter(List<ScoreDetailShichang.PingjiaxxsBean> dataList) {
		this.dataList = dataList;
	}

	public void setDataList(List<ScoreDetailShichang.PingjiaxxsBean> dataList) {
		this.dataList = dataList;
	}
	...
	class BillOflandSelectHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
		...
		public void bindData(ScoreDetailShichang.PingjiaxxsBean data){
