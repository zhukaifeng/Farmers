...
public class MarketNoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


    private MyItemClickListener myItemClickListener;

    private List<Market.MarketBean> dataList = new ArrayList<>();


    public MarketNoAdapter(List<Market.MarketBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<Market.MarketBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class DateHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(Market.MarketBean data){
