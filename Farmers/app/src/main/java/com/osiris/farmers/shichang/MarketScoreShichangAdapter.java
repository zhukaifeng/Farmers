...
public class MarketScoreShichangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
	...
	public MarketScoreShichangAdapter(List<MakeScoreData.PingjiaxxsBean> dataList) {
