...
public class StallNoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


    private MyItemClickListener myItemClickListener;

    private List<ChooseStallData.BoothglBean> dataList = new ArrayList<>();


    public StallNoAdapter(List<ChooseStallData.BoothglBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<ChooseStallData.BoothglBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class DateHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(ChooseStallData.BoothglBean data){
            tv_date.setText(data.getTwhmc());
