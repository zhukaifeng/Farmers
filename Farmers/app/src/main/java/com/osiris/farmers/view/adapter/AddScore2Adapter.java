...
public class AddScore2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AddScore2Adapter(List<AddScore.ZhanghglsBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<AddScore.ZhanghglsBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class BillOflandSelectHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindData(AddScore.ZhanghglsBean data) {
            ...
            if (!TextUtils.isEmpty(data.getJcyname())) {
