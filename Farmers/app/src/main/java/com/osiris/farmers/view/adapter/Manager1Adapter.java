...
public class Manager1Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Manager1Adapter(List<ManagerData1.DataBean> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_manager, parent,false);//解决宽度不能铺满
    ...
    class DateBacktoHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(ManagerData1.DataBean data){
            ...
            tv_title.setText(data.getZlkmc());
