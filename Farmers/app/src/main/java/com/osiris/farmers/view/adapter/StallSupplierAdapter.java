...
public class StallSupplierAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


    private MyItemClickListener myItemClickListener;

    private List<StoreSupplier.CustomerBean> dataList = new ArrayList<>();


    public StallSupplierAdapter(List<StoreSupplier.CustomerBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<StoreSupplier.CustomerBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class DateHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(StoreSupplier.CustomerBean data){
            tv_date.setText(data.getUserid());
