...
public class SuyuanJinDetailActivity extends BaseActivity {
...
//http://localhost:8096/wisdom/app/getJYHSprkById.action?id=2
        String url = ApiParams.API_HOST + "/app/getJYHSpckByJYHSprkId.action";

        Map<String, String> paramMap = new HashMap<>();
        paramMap.put("jyhSprkId", String.valueOf(id));
