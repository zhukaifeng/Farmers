...
public class XiaofangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{


    private MyItemClickListener myItemClickListener;

    private List<XiaofangXc.DataBean> dataList = new ArrayList<>();
    private View.OnClickListener onButtonClickListener;
    private View.OnClickListener onNameClickListener;


    public XiaofangAdapter(List<XiaofangXc.DataBean> dataList) {
        this.dataList = dataList;
    }

    public void setDataList(List<XiaofangXc.DataBean> dataList) {
        this.dataList = dataList;
    }
    ...
    class PunishListHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindData(XiaofangXc.DataBean data){
            ...
            tv_name.setText(data.getXiaofangdwName());
            if (!TextUtils.isEmpty(data.getTitleMsg())){
                tv_msg.setText(data.getTitleMsg());
            }else {
                tv_msg.setText("");
            }
