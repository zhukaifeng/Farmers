...
public class TypePurchaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public TypePurchaseAdapter(List<DateModel> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_select_type, parent,false);//解决宽度不能铺满
